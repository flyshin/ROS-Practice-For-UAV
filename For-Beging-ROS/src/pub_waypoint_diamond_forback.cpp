...
int main(int argc, char **argv)
{
   ...
   ros::Publisher dm_vtol_put = n.advertise<mavros_msgs::AttitudeTarget>("mavros/setpoint_raw/attitude",100);
   ...
   mavros_msgs::AttitudeTarget attitude_set;
  // int debugCount = 0
	
   while(ros::ok())
   {
       attitude_set.header.stamp = ros::Time::now();
       attitude_set.header.seq=count;
       attitude_set.header.frame_id = 1;
       ...
       */
       ...
       //attitude_set.orientation.w = quater_angle[0];
      // attitude_set.orientation.x = quater_angle[1];
      // attitude_set.orientation.y = quater_angle[2];
       //attitude_set.orientation.z = quater_angle[3];

       attitude_set.orientation.w = 1;
       attitude_set.orientation.x = 0;
       attitude_set.orientation.y = 0;
       attitude_set.orientation.z = 0;

       //attitude_set.body_rate.x =0.01;
       //attitude_set.body_rate.y =0.01;
       //attitude_set.body_rate.z =0.01;
       

       //attitude_set.thrust_scaling=0.1;
       attitude_set.thrust = 0.6;
       ...
       dm_vtol_put.publish(attitude_set); // Publish the topic 
